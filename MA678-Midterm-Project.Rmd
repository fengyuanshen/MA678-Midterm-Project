...
\log(\text{price}) = \alpha + \beta_1 \cdot \text{host\_is\_superhost} + \beta_2 \cdot \text{latitude} + \beta_3 \cdot \text{longitude} + \beta_4 \cdot \text{room\_type} + \beta_5 \cdot \text{accommodates} + \beta_6 \cdot \text{bathrooms} + \beta_7 \cdot \text{bedrooms} + \beta_8 \cdot \text{beds} + \beta_9 \cdot \text{minimum\_nights} + \beta_{10} \cdot \text{number\_of\_reviews} + \beta_{11} \cdot \text{review\_scores\_rating} + \beta_{12} \cdot \text{review\_scores\_location}
