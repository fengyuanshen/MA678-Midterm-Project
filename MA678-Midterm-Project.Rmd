...
\log(\text{price}) = \alpha + \beta\_1 \cdot \text{host\_is\_superhost} + \beta\_2 \cdot \text{latitude} + \beta\_3 \cdot \text{longitude} + \beta\_4 \cdot \text{room\_type} + \beta\_5 \cdot \text{accommodates} + \beta\_6 \cdot \text{bathrooms} + \beta*7* \cdot \text{bedrooms} + \beta*8* \cdot \text{beds} + \beta*9* \cdot \text{minimum\_nights} + \beta{10} \cdot \text{number\_of\_reviews} + \beta{11} \cdot \text{review\_scores\_rating} + \beta{12} \cdot \text{review\_scores\_location}
...
\log(\text{price}) = \alpha + \beta\_1 \cdot \text{host\_is\_superhost} + \beta\_2 \cdot \text{latitude} + \beta\_3 \cdot \text{longitude} + \beta*4* \cdot \text{room\_type} + \beta*5* \cdot \text{accommodates} + \beta*6* \cdot \text{bathrooms} + \beta*7* \cdot \text{bedrooms} + \beta*8* \cdot \text{beds} + \beta*9* \cdot \text{minimum\_nights} + \beta{10} \cdot \text{number\_of\_reviews} + \beta{11} \cdot \text{review\_scores\_rating} + \beta{12} \cdot \text{review\_scores\_location} + \beta{13} \cdot (\text{latitude} \cdot \text{longitude}) + \beta{14} \cdot (\text{accommodates} \cdot \text{bedrooms}) + \beta{15} \cdot (\text{review\_scores\_rating} \cdot \text{review\_scores\_location})
...
The Residual Plot and Q-Q Plot show the similar pattern to the previous model. However, the adjusted R-squared value of 0.4766 represents a slight improvement over the previous model, explaining approximately 47.66% of the variability in the transformed price. Therefore, the inclusion of interaction terms in the model did slghtly improve the model.

#### Model4: No Pooling Model

no pooling就是加一个factor

\log(\text{price}) = \alpha + \beta\_1 \cdot \text{host\_is\_superhost} + \beta\_2 \cdot \text{latitude} + \beta*3* \cdot \text{longitude} + \beta*4* \cdot \text{room\_type} + \beta*5* \cdot \text{accommodates} + \beta*6* \cdot \text{bathrooms} + \beta*7* \cdot \text{bedrooms} + \beta*8* \cdot \text{beds} + \beta*9* \cdot \text{minimum\_nights} + \beta{10} \cdot \text{number\_of\_reviews} + \beta{11} \cdot \text{review\_scores\_rating} + \beta{12} \cdot \text{review\_scores\_location} + \beta{13} \cdot (\text{latitude} \cdot \text{longitude}) + \beta{14} \cdot (\text{accommodates} \cdot \text{bedrooms}) + \beta{15} \cdot (\text{review\_scores\_rating} \cdot \text{review\_scores\_location}) + \beta{16} \cdot \text{host\_neighbourhood}
...
# Print the first 17 coefficients
print(coef_summary[1:17, ])
...
\log(\text{price}) = \alpha + \beta\_1 \cdot \text{host\_is\_superhost} + \beta\_2 \cdot \text{latitude} + \beta*3* \cdot \text{longitude} + \beta*4* \cdot \text{room\_type} + \beta*5* \cdot \text{accommodates} + \beta*6* \cdot \text{bathrooms} + \beta*7* \cdot \text{bedrooms} + \beta*8* \cdot \text{beds} + \beta*9* \cdot \text{minimum\_nights} + \beta{10} \cdot \text{number\_of\_reviews} + \beta{11} \cdot \text{review\_scores\_rating} + \beta{12} \cdot \text{review\_scores\_location} + \beta{13} \cdot (\text{latitude} \cdot \text{longitude}) + \beta{14} \cdot (\text{accommodates} \cdot \text{bedrooms}) + \beta{15} \cdot (\text{review\_scores\_rating} \cdot \text{review\_scores\_location}) + b{\text{host\_neighbourhood}}
