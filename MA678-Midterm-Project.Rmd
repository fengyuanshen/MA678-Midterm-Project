...
**lm(log(price) \~ host_is_superhost + latitude + longitude + room_type + accommodates + bathrooms + bedrooms + beds + minimum_nights + number_of_reviews + review_scores_rating + review_scores_location)**
...
**lm(log(price) \~ host_is_superhost + latitude + longitude + room_type + accommodates + bathrooms + bedrooms + beds + minimum_nights + number_of_reviews + review_scores_rating + review_scores_location + latitude:longitude + accommodates:bedrooms + review_scores_rating:review_scores_location)**
...
**lm(log(price) \~ host_is_superhost + latitude + longitude + room_type + accommodates + bathrooms + bedrooms + beds + minimum_nights + number_of_reviews + review_scores_rating + review_scores_location + latitude:longitude + accommodates:bedrooms + review_scores_rating:review_scores_location + factor(host_neighbourhood))**
...
**lmer(log(price) \~ host_is_superhost + latitude + longitude + room_type + accommodates + bathrooms + bedrooms + beds + minimum_nights + number_of_reviews + review_scores_rating + review_scores_location + latitude:longitude + accommodates:bedrooms + review_scores_rating:review_scores_location + (1 \| host_neighbourhood))**
